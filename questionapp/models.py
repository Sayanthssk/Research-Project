...
class Question(models.Model):
    ...
    option1 = models.CharField(max_length=100, help_text="Wrong option 1")
    option2 = models.CharField(max_length=100, help_text="Wrong option 2")
    option3 = models.CharField(max_length=100, help_text="Wrong option 3")
    image = models.ImageField(upload_to='question_images/', help_text="Upload image for the question.")
...
class Result(models.Model):
    ...
    QUESTIONID = models.ForeignKey(Question, on_delete=models.CASCADE, null=True, blank=True)
